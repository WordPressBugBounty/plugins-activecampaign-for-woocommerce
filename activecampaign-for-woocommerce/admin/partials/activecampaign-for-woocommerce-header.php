	...
	<header id="activecampaign-for-woocommerce-app-header" class="sticky top-600 p-600 z-10">
		<div class="flex items-center">
			<div class="logo">
				...
				<h1>
					<?php
					esc_html_e( 'ActiveCampaign for WooCommerce', 'activecampaign' );
					?>
				</h1>
			</div>
		...
		<div class="flex items-center">
		<span class="mr-400">
		<a href="https://help.activecampaign.com/hc/en-us/articles/115000652490-WooCommerce-Deep-Data-integration-overview"
			target="_blank"
			rel="noopener noreferrer"><span><?php esc_html_e( 'Learn more about ActiveCampaign for WooCommerce', 'activecampaign' ); ?></span><svg
					class="is-styled css-ws9hmn" height="16px" width="16px" role="img" viewBox="0 0 16 16"
...
<?php if ( Activecampaign_For_Woocommerce_Utilities::valid_permission( 'admin' ) && is_admin() && ! is_plugin_active( 'activecampaign-subscription-forms/activecampaign.php' ) ) { ?>
	<div class="notice notice-success"><p>Be sure to also install the <a
					href="/wp-admin/plugin-install.php?s=ActiveCampaign&tab=search&type=term"
					aria-label="More information about ActiveCampaign" data-title="ActiveCampaign" target="_blank">ActiveCampaign
				Forms, Site Tracking, & Live Chat plugin</a> to capitalize on all of the awesome capabilities of
			ActiveCampaign. You can:</p>
		<ul>
			<li>&mdash; Easily embed forms to your website.</li>
			<li>&mdash; Track visitors to your site to target shoppers to boost conversion.</li>
			<li>&mdash; Enable live chat for accounts using Conversations (our site messaging platform)!</li>
		</ul>
		<a href="/wp-admin/plugin-install.php?s=ActiveCampaign&tab=search&type=term"
			aria-label="More information about ActiveCampaign" data-title="ActiveCampaign" target="_blank">Install
			now</a></p></div>
<?php } ?>
	<div id="update-notifications"></div>

	<hr/>
<?php if ( isset( $_GET['page'] ) && 'activecampaign_for_woocommerce' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) : ?>
